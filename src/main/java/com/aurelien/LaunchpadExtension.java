...
public class LaunchpadExtension extends ControllerExtension
{
   ...
   public void init()
   {
      ...
      m_host.showPopupNotification("Launchpad S Initialized");
   }
   ...
   {
      Reset();
      m_host.showPopupNotification("Launchpad S Exited");
   }
   ...
   {
      return midiInPort.createNoteInput("Launchpad S", "8000??", "9000??", "8001??", "9001??", "8002??", "9002??", "8003??", "9003??", "8004??", "9004??", "8005??", "9005??", "8006??", "9006??", "8007??", "9007??", "8010??", "9010??", "8011??", "9011??",
